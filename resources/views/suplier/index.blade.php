                        ...
                        <div class="animated fadeIn">  
                                ...
                                <div class="card-header"> 
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          <td><h5 class="card-title">Data Suplier</span></h5></td>
                                          <td> 
                                            <div align="right">   
                                              ...
                                              <a href="{{ url('impsuplier')}}"  class="btn btn-success btn-sm"  role="button" aria-disabled="true">
                                                <span class="bi bi-upload" style="font-size:16px"> Import Data</span> </a> 
                                                <a href="{{ url('expsuplier')}}"  class="btn btn-success btn-sm"  role="button" aria-disabled="true">
                                                ...
                                                <thead>
                                                    ...
                                                    @foreach ($suplier as $item)
                                                        ...
                                                        <td>{{$item -> telepon_suplier}}</td>   
                                                          <td>
                                                                <a href="{{ url('suplier/' .$item->id_suplier.'/edit')}}" class="btn btn-success btn-sm" >
