                        ...
                        <div class="animated fadeIn">
                            ...
                            @endif
                                ...
                                <div class="card-header"> 
                                 ...
                                 <tr>
                                  <td><h5 class="card-title">Ubah Data Jenis Barang</span></h5></td>
                                  <td> 
                                    ...
                                    <div class="card-body">  
                                        <form action="{{ url('jenis/' .$jenis->id_jenis) }}" method="post"  enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-3">
                                              ...
                                              <div class="col-sm-10">
                                                  <input type="text" class="form-control"  readonly  value="{{ old('id_jenis',$jenis->id_jenis) }}"  name="id_jenis"  required autofocus>
                                                </div>
                                            </div> 
                                              <div class="row mb-3">
                                                  <label for="nik" class="col-sm-2 col-form-label">Jenis Barang</label>
                                                  <div class="col-sm-10">
                                                      <input type="text" class="form-control"    value="{{ old('jenis_barang',$jenis->jenis_barang) }}"  name="jenis_barang"  required autofocus>
                                                    </div>
                                                </div> 
